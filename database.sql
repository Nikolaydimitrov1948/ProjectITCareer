...
/****** Object:  Database [TestFootball]    Script Date: 09.03.2023 18:29:51 ******/
CREATE DATABASE [TestFootball]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TestFootball', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER01\MSSQL\DATA\TestFootball.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TestFootball_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER01\MSSQL\DATA\TestFootball_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [TestFootball] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [TestFootball] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [TestFootball] SET RECOVERY FULL 
GO
...
ALTER DATABASE [TestFootball] SET QUERY_STORE = OFF
GO
